  ...
  <body style="text-align: center; background-color: #d2ffb7">

  <h1 style="text-align: center;"><br>Comparação de quantidade de livros por subgênero de Acadêmico</h1>
  ...
  <script>
      ...
      var width = 350;
      var height = 350;
      $.post("dados-graficos2.php",{academico:"academico"}, function(d){
        var k = JSON.parse(d);
        console.log(k);
